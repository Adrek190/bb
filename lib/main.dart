...
import 'package:student_transport_app/presentation/pages/all_trips_page.dart';
...
import 'package:student_transport_app/presentation/providers/user_profile_provider.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => UserProfileProvider()..initializeUserData(),
      child: MaterialApp(
        ...
        routes: {
          ...
          '/all-trips': (context) => const AllTripsPage(),
